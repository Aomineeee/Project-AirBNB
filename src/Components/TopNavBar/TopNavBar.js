...
export default function TopNavBar() {
  ...
  const isTabletDesktop = useMediaQuery({ query: "(min-width: 769px)" });

  return (
    <header className="text-gray-600 body-font bg-black pb-10">
          ...
          <>
            <div className="px-0 py-3 container">
              <div className="row pb-2">
                {/* Logo */}
                <Link to="/" className="col-lg-2 col-md-6 py-3 order-1">
                  <svg
                    width={102}
                    height={32}
                    fill="currentcolor"
                ...
                {/* Menu */}
                <nav className="col-lg-6 col-md-12 py-3 order-lg-2 order-md-3">
                  <div className="flex items-center text-base justify-content-lg-end justify-content-md-center space-x-5 ">
                    <a className="active hover:text-gray-300 text-white flex flex-col justify-center items-center">
                      <span className="mb-1">Nơi ở</span>
                      <div className="line"></div>
                    </a>
                    <a className=" hover:text-gray-300 text-white flex flex-col justify-center items-center">
                      <span className="mb-1">Trải nghiệm</span>
                      <div className="line"></div>
                    </a>
                    <a className="hover:text-gray-300 text-white flex flex-col justify-center items-center">
                      <span className="mb-1">Trải nghiệm thực tế</span>
                      <div className="line"></div>
                    </a>
                  </div>
                </nav>
                {/* User */}
                <div className="col-lg-4 col-md-6 order-lg-3 order-md-2 p-0 text-right">
                  <button className="inline-flex items-center border-0 py-3 px-3 focus:outline-none text-white hover:bg-white hover:bg-opacity-10 rounded-full text-base mt-4 md:mt-0">
                    Đón tiếp khách
                  </button>
                  <button className="inline-flex items-center border-0 py-3 px-3 focus:outline-none hover:bg-white hover:bg-opacity-10 rounded-full text-base mt-4 mx-3 md:mt-0">
                    <svg
                      viewBox="0 0 16 16"
